...
//
// SCILogarithmicNumericTickProvider.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Creates a new instance of `SCILogarithmicNumericTickProvider` class.
 */
